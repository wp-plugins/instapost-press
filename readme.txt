...
1. Delete any existing `instapost-press` folder from the `/wp-content/plugins/` directory
2. Upload `instapost-press` folder to the `/wp-content/plugins/` directory
